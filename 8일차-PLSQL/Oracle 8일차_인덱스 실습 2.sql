...
SELECT COUNT(*) FROM KH_CUSTOMER_TBL;  -- 1000001개 (100만개 데이터 들어갔다)
...
-- 설명되었습니다.
SELECT * FROM TABLE(DBMS_XPLAN.DISPLAY);  -- 시간체크
-- 4047, 00:00:49, TABLE ACCESS FULL
...
-- 설명되었습니다.
SELECT * FROM TABLE(DBMS_XPLAN.DISPLAY);  -- 시간체크
-- 1852, 00:00:23, TABLE ACCESS BY INDEX ROWID, INDEX RANGE SCAN
-- 시간이 줄어들었다.
